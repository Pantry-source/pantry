...
export default function Dropdown({ categories, onCategoryChange, setSelectedCategory }) {
  ...
  return (
    <Combobox as="div" value={selectedPerson} onChange={(e)=>setSelectedCategory(e.name)}>
