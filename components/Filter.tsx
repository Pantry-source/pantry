...
// type ValidCategoriesProp = {
//   validCategories: categoryApi.Category[];
//   updateCategoryIds: (filter: any) => void;
...
// export default function Filter({ updateCategoryIds, updateFilters, validCategories }: ValidCategoriesProp) {
//   const [open, setOpen] = useState(false);
//   const [activeFilters, setActiveFilters] = useState([] as any[]);
//   const [filters, setFilters] = useState(filterSection.options);
//   const [categories, setCategories] = useState([] as any[]);
...
//   */
//   function onChange(e: ReactEventHandler<HTMLInputElement>) {
